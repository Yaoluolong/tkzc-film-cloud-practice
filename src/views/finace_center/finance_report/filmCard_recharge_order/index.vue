    ...
    <el-form inline label-width="120px">
      ...
      <el-form-item label="订单状态">
        <remote-select
          ...
          :query="{type:'cardRechargeOrderStatus'}"
          style="width:230px;"
        ></remote-select>
      </el-form-item>
    ...
    <page-table ref="table" index :query="query" :fetch="queryTable">
      ...
      <el-table-column min-width="250" label="操作" align="center" prop="oper" fixed="right">
        <template slot-scope="{row}">
          <el-button
            type="text"
            @click="$router.push({path:'/finace_center/finance_report/card_recharge_order/order_detail', query:{orderId:row.id}})"
          >查看详情</el-button>
...
import {
  getCardRechargeOrderPageList,
  getCardRechargeBatchOrderStatus,
  getSyncOrderCardRechargeStatus,
  exportOrderRechargeData
