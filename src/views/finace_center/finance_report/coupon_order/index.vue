  ...
  <div class="app-container">
    ...
    >
      ...
      <div class="item" v-if="params.type!=='2'">
        <span>可兑付影片面值：</span>
        <span>{{params.priceRule}}元</span>
      </div>
      <div class="item" v-else>
        <span>可优惠影片面值：</span>
        <span>{{params.priceRule}}元</span>
      </div>
      <div class="item" v-if="params.type==='3' && diffType==='1'">
        <span>补差金额：差额补差（影片售价-最大兑付影片面值）</span>
      </div>
      ...
      <div class="item">
        <span>已绑定：</span>
        <span>{{params.countBind}}张</span>
      </div>
      <div class="item">
        <span>已使用：</span>
        <span>{{params.countUse}}张</span>
      </div>
      <div class="item">
        <span>已作废：</span>
        <span>{{params.countVoid}}张</span>
      </div>
      <div class="item">
        <span>已冻结：</span>
        <span>{{params.countFrozen}}张</span>
      </div>
      <div class="item">
        <span>已过期：</span>
        <span>{{params.countVoid}}张</span>
      ...
      <div class="item">
        ...
        <span>
          ...
          <span style="color:blue;">电影券实际作用在影片面值上的总额除以销售总额）</span>
        </span>
      </div>
