  ...
  <div class="app-container">
    <el-card class="box-card">
      ...
      <el-form label-width="120px" label-position="left" style="width:1000px;">
        <el-form-item label="商家名称" prop="name">{{params.name}}</el-form-item>
        ...
        <el-form-item label="消费终端" prop="deviceCode">{{params.deviceName}}</el-form-item>
        <el-form-item label="请求平台接口" prop="requestUrl">{{params.requestUrl ||'无'}}</el-form-item>
        <el-form-item
          label="获取退款通知"
          style="width:320px"
          prop="refundNotifyUrl"
          v-if="params.type==2"
        >{{params.refundNotifyUrl}}</el-form-item>
        <el-form-item
          label="渠道商账号"
          style="width:320px"
          prop="channelAccount"
        >{{params.channelAccount}}</el-form-item>
        <el-form-item label="渠道商密码" style="width:320px" prop="password">{{params.password}}</el-form-item>
        <div v-if="params.type === '2'">
          <el-form-item label="渠道停售时间" style="width:320px" prop="stopTime">{{params.stopTime}}分钟</el-form-item>
          <el-form-item label="渠道退票时间" style="width:320px" prop="refundTime">{{params.refundTime}}分钟</el-form-item>
        </div>
        ...
        <div>
          <el-form-item
            label="请求超时时间"
            style="width:320px"
            prop="requestOverTime"
          >{{params.requestOverTime}}秒</el-form-item>
          <el-form-item
            label="响应超时时间"
            style="width:320px"
            prop="responseOverTime"
          >{{params.responseOverTime}}秒</el-form-item>
          <el-form-item
            label="更新排期场次"
            style="width:320px"
            prop="responseOverTime"
          >{{params.responseOverTime}}分钟</el-form-item>
          <el-form-item
            label="定价方式"
            style="width:320px"
            prop="pricingType"
          >{{getPricingType(params.pricingType)}}</el-form-item>
          <el-form-item
            label="技术服务费"
            style="width:320px"
            prop="technicalServiceFee"
          >{{params.technicalServiceFee||'0.00'}}元</el-form-item>
        </div>
        ...
        <div v-if="params.type === '1'">
          ...
          >{{params.ticketPriceMoney}} : {{params.ticketPriceChange}}</el-form-item>
                  ...
                  >
                    <ul class="ul">
                      ...
                      <li class="ul-li" v-for="(el,index) in interfaceActionList" :key="index">
                        <el-checkbox :label="el.action" disabled>{{el.actionName}}</el-checkbox>
                      </li>
                    </ul>
                  </el-checkbox-group>
                </div>
