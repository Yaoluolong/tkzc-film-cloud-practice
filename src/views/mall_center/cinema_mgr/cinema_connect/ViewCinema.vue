            ...
            <title-plane class="baseInfo" >
              ...
              <template v-if="params.serviceTelType==2">
                <el-form-item label="微信H5" prop="wap1" class="inner-item" >
                      <el-input v-model.trim="params.wap1" disabled v-if="params.wap1"></el-input>
                      <el-input v-model.trim="params.wap2" style="margin-left:20px" disabled v-if="params.wap2"></el-input>
                </el-form-item>
                 <el-form-item label="移动APP" prop="app1"  class="inner-item" >
                      <el-input v-model="params.app1" disabled v-if="params.app1"></el-input>
                      <el-input v-model="params.app2" style="margin-left:20px" disabled v-if="params.app2"></el-input>
                </el-form-item>
                <el-form-item label="小程序" prop="web1"  class="inner-item" >
                      <el-input v-model="params.web1" disabled v-if="params.web1"></el-input>
                      <el-input v-model="params.web2" style="margin-left:20px" disabled v-if="params.web2"></el-input>
                </el-form-item>
              </template>
              <el-form-item  v-else prop="serviceTel1" class="inner-item">
                <el-input v-model.trim="params.serviceTel1" disabled v-if="params.serviceTel1"></el-input>
                <el-input v-model.trim="params.serviceTel2" style="margin-left:20px;" disabled v-if="params.serviceTel2"></el-input>
              </el-form-item>
            </title-plane>
          </el-form-item>
      	</el-form>
            ...
            <title-plane>
              ...
              <template v-if="params.ticketConfigRadio==2">
                ...
                <el-form-item label="调用接口参数" prop="ticketConfig.otherInfo"  class="inner-item" >
                      <el-form-item :label="key" v-for="(val,key) in params.ticketConfig.otherInfo" :key="key" class="inner-item" width="60%">
                        <el-input disabled v-model="params.ticketConfig.otherInfo[key]"></el-input>
                      </el-form-item>
                </el-form-item>
              </template>
            </title-plane>
            ...
            <title-plane>
              ...
              <template v-if="params.refundType==1">
                <el-form-item  prop="refundTime"  class="inner-item" >
                  ...
                  <el-input v-model="params.refundTime" disabled placeholder="请输入" style="margin-right:20px;width:320px">
