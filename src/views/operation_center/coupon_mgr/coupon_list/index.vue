    ...
    <div class="app-container">
         <el-form inline label-width="120px">
            ...
            <el-form-item label="电影券号码">
              <el-input v-model="query.couponCodeLeft" clearable placeholder="输入优惠券号码查询" style="width:230px;"></el-input>  ~~
              <el-input v-model="query.couponCodeRight" clearable placeholder="输入优惠券号码查询" style="width:230px;"></el-input>
            </el-form-item>
            ...
            <el-form-item label="电影券种类">
              <remote-select v-model="query.type" showAllOption placeholder="请选择电影券种类" action="/systemApi/dict/getList" :query="{type:'couponType'}" style="width:230px;"></remote-select>
            </el-form-item>
            <el-form-item label="电影券类型">
              <remote-select v-model="query.style" showAllOption placeholder="请选择电影券类型" action="/systemApi/dict/getList" :query="{type:'couponStyle'}" style="width:230px;"></remote-select>
            </el-form-item>
            <el-form-item label="会员手机号">
              <el-input v-model="query.bindingMobile" clearable placeholder="请输入会员手机号" style="width:230px;"></el-input>
            </el-form-item>
            <el-form-item >
            ...
            <query-ext-plane :opened="opened">
                ...
                <el-form-item label="业务人员">
                  <operator-id-selector :accessType="couponLimit" v-model="query.operator" placeholder="请输入业务人员名称模糊查询"></operator-id-selector>
                </el-form-item>
                <el-form-item label="客户名称">
                  <customer-selector :accessType="couponLimit" v-model="query.customerName" :isAddNew="false"></customer-selector>
                ...
                <el-form-item label="电影券核销方式">
                  <remote-select v-model="query.useType" showAllOption placeholder="请选择电影券核销方式" action="/systemApi/dict/getList" :query="{type:'couponUseType'}" style="width:230px;"></remote-select>
                </el-form-item>
            </query-ext-plane>
         </el-form>
...
import { getSoldCouponList, exportSaleCouponList, setCouponVoid, setCouponFrozen, getSaleCouponCount, setdelaysCoupon } from '@/api/operationCenter'
...
export default {
  ...
  watch: {
    'query.type'(val) {
      if (val === undefined) { this.$set(this.query, 'type', '-1') }
    },
    'query.style'(val) {
      if (val === undefined) { this.$set(this.query, 'style', '-1') }
    },
    'query.useType'(val) {
      if (val === undefined) { this.$set(this.query, 'useType', '-1') }
    }
  },
  computed: {
    queryTemp: function() {
