<template>
    <div class="app-container">
        <el-card style="margin-bottom:20px">
            ...
            <el-form label-width="160px" label-position="right" style="width:1000px;" :model="couponInfo" :rules="rules" ref="formCard">
        ...
        <el-card style="margin-bottom:20px">            
          <el-card shadow="never" style="width:800px;margin-top:20px;margin-bottom:15px;">
            <el-form label-width="140px" label-position="right" style="width:1000px;" v-show="$route.query.checkStatus=='1'">
        ...
        <el-button style="margin-top:20px;" type="primary" @click="checkOrder" v-show="$route.query.checkStatus=='1'">同意</el-button>
  ...
  methods: {
    checkOrder() {
      ...
      if (this.$route.query.orderNo) {
        couponcheckOrder({ orderNo: this.$route.query.orderNo, agree: '1', suggestion: this.suggestion }).then((res) => {
    ...
    refund() {
      const _this = this
      if (this.$route.query.orderNo) {
        couponcheckOrder({ orderNo: this.$route.query.orderNo, agree: '2', suggestion: this.suggestion }).then((res) => {
  ...
  async created() {
    if (this.$route.query.orderNo) {
      ...
      getCouponOrderInfo(this.$route.query.orderNo).then((res) => {
        ...
        if (res.couponInfo.checkInfo && res.couponInfo.checkInfo.suggestion !== 'null') {
        ...
        if (_this.programInfo.ruleList[0].settlementType === '1' && _this.programInfo.ruleList[0].diffType === '2') {
        ...
        } else if (_this.programInfo.ruleList[0].settlementType === '2' && _this.programInfo.ruleList[0].diffType === '2') {
          Object.keys(_this.programInfo.ruleList[0].diffRule).forEach(e => {
            this.diffRuleArr.push({ name: e, value: _this.programInfo.ruleList[0].diffRule[e] })
          })
        }
