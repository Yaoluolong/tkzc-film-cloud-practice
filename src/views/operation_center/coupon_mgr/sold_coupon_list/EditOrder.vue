<template>
    <div class="app-container">
        <el-card v-if="ok">
            ...
            <el-form label-width="140px" label-position="left" style="width:1000px;" :model="couponInfo" :rules="rules" ref="formCard">
                ...
                <el-form-item label="电影券种类" prop="type">
                  <remote-select v-model="couponInfo.type" clearable placeholder="请选择电影券种类" action="/systemApi/dict/getList" :query="{type:'couponType'}" style="width:230px;"></remote-select>
                </el-form-item>
                <el-form-item label="电影券类型" prop="style">
                  <remote-select v-model="couponInfo.style" clearable placeholder="请选择电影券类型" action="/systemApi/dict/getList" :query="{type:'couponStyle'}" style="width:230px;"></remote-select>
                </el-form-item>
                <el-form-item label="电影券号" prop="codeIdDetail">
                  <coupon-code-area :outCheckId="doGet" v-model="couponInfo.codeIdDetail" :couponType="couponInfo.type" :couponStyle="couponInfo.style" :orderNo="$route.query.orderNo"></coupon-code-area>
                </el-form-item>
                <el-form-item label="销售数量:" prop="num">
                    <el-input v-model.trim="couponInfo.num" placeholder="0" style="width:100px;" disabled></el-input> 张  <span style="margin-left:20px;color:red">系统已根据您所填写的号码段自动统计出销售数量!</span>
                </el-form-item>
                ...
                <el-form-item label="销售单价:">
                    <el-input v-model.trim="couponInfo.unitPrice" placeholder="0.00" style="width:100px;" ></el-input> 元 <span style="margin-left:20px;color:gray">只能是数值，限2位小数</span>
                </el-form-item>                    
                ...
                <el-form-item label="可兑换影片售价区间:" label-width="160px;" v-if="couponInfo.type==1" prop="priceRule">
                  <price-area v-model="couponInfo.priceRule"></price-area>
                </el-form-item>

                <el-form-item  label="可优惠电影售价:" prop="canFreePrice" label-width="150px;" v-if="couponInfo.type==2">
        ...
        <el-card style="margin-top:10px" v-if="ok && ok1">
            ...
            <el-form label-width="140px" label-position="left" style="width:1000px;" :model="invoiceInfo" :rules="rules" ref="formInvoiceInfo">
                ...
                <template v-if="invoiceInfo.invoiceType && invoiceInfo.invoiceType !== '1'">
                    ...
                    <el-form-item label="发票领取:" prop="receiveType" v-if="invoiceInfo.invoiceType === '4' || invoiceInfo.invoiceType === '2' || invoiceInfo.invoiceType === '6'">
                    ...
                    <el-form-item label="收件人:" prop="receiveName" v-if="invoiceInfo.invoiceType === '4' || invoiceInfo.invoiceType === '2' || invoiceInfo.invoiceType === '6'">
                        <el-input v-model.trim="invoiceInfo.receiveName" placeholder="输入快递收件人姓名" style="width:200px;" ></el-input> 
                    </el-form-item>
                    <el-form-item label="联系电话:" prop="receiveMobile" v-if="invoiceInfo.invoiceType === '4' || invoiceInfo.invoiceType === '2' || invoiceInfo.invoiceType === '6'">
                        <el-input v-model.trim="invoiceInfo.receiveMobile" placeholder="输入快递收件人联系电话" style="width:200px;" ></el-input> 
                    </el-form-item>
                    <el-form-item label="收件地址:" prop="receiveAddress" v-if="invoiceInfo.invoiceType === '4' || invoiceInfo.invoiceType === '2' || invoiceInfo.invoiceType === '6'">
                        <el-input v-model.trim="invoiceInfo.receiveAddress" placeholder="输入快递收件人收件地址" style="width:200px;" ></el-input> 
                    </el-form-item>
...
import { getInvoiceTypeList, getCouponOrderInfo, updateCouponOrder } from '@/api/operationCenter'
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        canFreePrice: [
          { required: true, message: '请输入可优惠电影电影售价', trigger: 'blur' },
          { validator: betweenInt(1, 0), message: '须是大于0的数值', trigger: 'blur' }
        ],
        amount: [
