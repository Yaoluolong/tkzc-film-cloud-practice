<template>
    <el-card v-if="detail.invoiceType !== '1'" shadow="never" style="width:800px;margin-top:20px;margin-bottom:15px;">
        <el-form label-width="100px" :model="submitData" inline-message ref="form" label-position="right" :rules="rules">
            <el-form-item label="发票类型:">
                <div style="float:right"> <span :style="style"> {{detail.isDrawInvoice === '1' ? '已开票' : '未开票'}}</span></div>
            ...
            <el-form-item v-if="detail.invoiceType !== '1'" label="发票号:" prop="invoiceNo">
                <el-input style="width:250px;" v-model="submitData.invoiceNo" placeholder="输入发票号"></el-input>
            </el-form-item>
            <el-form-item v-if="detail.invoiceType !== '1'" label="开票金额:" prop="invocieMoney">
                <el-input style="width:100px" v-model="submitData.invocieMoney" placeholder="0.00"></el-input>  元
            </el-form-item>
            ...
            <el-form-item v-if="detail.receiveType == '1'" label="运单号:" prop="transportNo">
             ...
             <el-form-item style="margin-top:30px">
                <el-button style="margin-left:180px" type="primary" v-if="detail.isDrawInvoice === '0'" @click="save">确定开票</el-button>
            </el-form-item>
        </el-form>
    </el-card>
</template>
