<template>
    <div class="app-container">
        <el-form label-width="140px" label-position="left" style="width:1000px;" :model="query" ref="formCard">
            ...
            <div v-if="$route.query.level==='1' && query.auditStatus==='1'">
              <div>=============================================</div> 
              <h3>审核环节:一级审批</h3>
            ...
            <div v-if="$route.query.level==='2' && query.auditStatus==='2'">
              <div>=============================================</div> 
              <h3>审核环节:二级审批</h3>
              <el-form-item label="审核意见:" prop="comment">
                <el-input v-model="params.comment" type="textarea" rows="5" style="width:400px;"></el-input>
            ...
            <div v-if="$route.query.level==='2' && query.auditStatus==='3'">
              <div>=============================================</div> 
              <h3>审核环节:二级审批</h3>
              <el-form-item label="审核意见：">
