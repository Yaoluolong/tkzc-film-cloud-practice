  ...
  <div class="app-container">
    <el-form label-width="120px"  style="width:600px;" :model="params" :rules="rules" ref="form">
      <el-form-item label="手机号码" prop="userName" >
          <el-input v-model="params.mobile" placeholder="请输入手机号码" disabled></el-input>
      </el-form-item>
      ...
      <el-form-item label="生日" prop="email">
        <el-date-picker v-model="params.birthday" type="date" value-format="yyyy-MM-dd"  placeholder="选择日期">
    </el-date-picker>
      </el-form-item>
      ...
      <el-form-item label="新密码" prop="passWord">
        <el-input v-model.trim="params.passWord" type="password" placeholder="请输入登录密码" disabled></el-input>
      </el-form-item>
      <el-form-item label="确认密码" prop="rePassWord" >
        <el-input v-model.trim="params.rePassWord"  type="password" placeholder="请输入确认密码" disabled></el-input>
      </el-form-item>
...
export default {
  ...
  async created() {
    ...
    if (this.$route.query.id) {
      ...
      this.area = [this.params.provinceId, this.params.cityId].filter(item => item)
    }
  }
}
</script>
