    ...
    >
      ...
      <el-form-item v-if="detail.invoiceType !== '1'" label="开票说明:">
        ...
        <el-input
          ...
          style="width:400px"
          type="textarea"
          v-model="detail.drawInvoiceExplain"
          placeholder="请输入开票说明"
        ></el-input>
      </el-form-item>
      ...
      <!-- <el-form-item v-if="detail.receiveType == '1'" label="配送公司:" prop="transportName">
                <el-input clearable  style="width:250px;" v-model="submitData.transportName" placeholder="输入快递公司名称"></el-input>
            </el-form-item>
            <el-form-item v-if="detail.receiveType == '1'" label="运单号:" prop="transportNo">
                <el-input clearable   style="width:250px;" v-model="submitData.transportNo" placeholder="输入快递运单号"></el-input>
      </el-form-item>-->
      <el-form-item label="开票状态:" v-if="detail.isDrawInvoice === '1'">{{detail.isDrawInvoiceStr}}</el-form-item>
      <el-form-item label="开票人:" v-if="detail.isDrawInvoice === '1'">{{detail.drawInvoicePeople}}</el-form-item>
      <el-form-item label="开票时间:" v-if="detail.isDrawInvoice === '1'">{{detail.drawInvoiceTime}}</el-form-item>
