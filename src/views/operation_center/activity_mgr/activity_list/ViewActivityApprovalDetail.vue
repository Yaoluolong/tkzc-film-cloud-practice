<template>
    <div class="app-container">
        ...
        <el-card style="margin-bottom:20px" v-if="activityInfo.settings.activity_type==='cash' || activityInfo.audit_code!=='1'">
          ...
          <!-- <el-button style="margin-top:20px;" type="primary" @click="save('accept')" v-if="$route.query.status==='审批中'">同意</el-button>
          <el-button style="margin-top:20px;" type="primary" @click="save('reject')" v-if="$route.query.status==='审批中'">退回</el-button>
          <el-button @click="closeTab(true)" v-if="$route.query.status==='审批中'">取消</el-button> -->
        </el-card>                
    </div>
</template>
