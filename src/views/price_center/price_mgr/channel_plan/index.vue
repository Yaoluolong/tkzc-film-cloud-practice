<template>
    <div class="app-container">
         ...
         <page-table ref="table" index :query="query" :fetch="queryTable">
            ...
            <el-table-column min-width="140"  label="商家名称" align="center" prop="channelName"></el-table-column>
            ...
            <el-table-column width="140"  label="更新排期时间" align="center" prop="updateTime"></el-table-column>
