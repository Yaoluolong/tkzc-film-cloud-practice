<template>
    <div class="app-container">
         ...
         <page-table ref="table" index :query="query" :fetch="queryTable" >
            <el-table-column min-width="150" align="center" label="价格方案名称" prop="name" show-overflow-tooltip></el-table-column>
            <el-table-column min-width="150" align="center" label="归属影院定价分组" prop="policyGroupName" ></el-table-column>
            <el-table-column min-width="140" align="center" label="执行平台商家" prop="channelName" show-overflow-tooltip></el-table-column>
            <el-table-column min-width="180" align="center" label="方案有效时间" prop="priceRightConfig" v-if="query.programType==1">
              <template slot-scope="{row}">
                {{row.startDate}}--{{row.endDate}}
              </template>
            </el-table-column>
            <el-table-column min-width="100" align="center" label="方案类型" prop="typeName"></el-table-column>
            <el-table-column min-width="160" align="center" label="添加时间" prop="createTime" show-overflow-tooltip></el-table-column>
            <el-table-column min-width="100" align="center" label="创建人" prop="operator"></el-table-column>
            <el-table-column min-width="220" align="center" label="操作" prop="oper" fixed="right">
              <template slot-scope="{row}">
