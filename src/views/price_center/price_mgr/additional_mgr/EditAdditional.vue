...
import { getPayTypeList, createSpecialServicePrice, getChannelSpecialServicePriceInfo, updateSpecialServicePrice } from '@/api/priceCenter'
export default {
  name: 'edit_additional_mgr',
  components: { DateSelector, CinemaSelector, ChannelSelector, HallSelector, StandardSelector, FilmSelector, ChannelIdSelector },
  data() {
    return {
      channelId: '',
      cinemaList: [],
