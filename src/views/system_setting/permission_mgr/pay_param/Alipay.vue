      ...
      <el-form :model="alipayParam.configDetail" inline label-width="150px" :rules="rules">
        ...
        <el-card class="box-card">
          <el-form-item label="partnerId" prop="aliPayPid">
            <el-input
              clearable
              v-model.trim="alipayParam.configDetail.aliPayPid"
              placeholder="请输入内容"
            ></el-input>
          </el-form-item>
          <el-form-item label="sellerEmail" prop="aliPayAppId">
            <el-input
              clearable
              v-model.trim="alipayParam.configDetail.aliPayAppId"
              placeholder="请输入内容"
            ></el-input>
          </el-form-item>
          <el-form-item label="key" prop="aliPayPublicSecret">
            <el-input
              clearable
              v-model.trim="alipayParam.configDetail.aliPayPublicSecret"
              placeholder="请输入内容"
            ></el-input>
          </el-form-item>
          <el-form-item label="加密方式" prop="aliPayEncryptType">
            <el-select
              clearable
              v-model="alipayParam.configDetail.aliPayEncryptType"
              placeholder="请选择"
              style="width: 187px;"
            >
              <el-option
          ...
          <el-form-item label="公钥" prop="merchantPublicSecret" class="attributes">
            <el-input
              clearable
              class="scription"
              v-model.trim="alipayParam.configDetail.merchantPublicSecret"
              type="textarea"
              placeholder="请输入内容最多10个字"
            ></el-input>
          </el-form-item>
          <el-form-item label="PHP私钥" prop="merchantPrivateSecret" class="attributes">
            <el-input
              clearable
              class="scription"
              v-model.trim="alipayParam.configDetail.merchantPrivateSecret"
              type="textarea"
              placeholder="请输入内容最多10个字"
            ></el-input>
          </el-form-item>
          <el-form-item label="java私钥" prop="merchantJavaPrivateSecret" class="attributes">
            <el-input
              clearable
              class="scription"
              v-model.trim="alipayParam.configDetail.merchantJavaPrivateSecret"
              type="textarea"
              placeholder="请输入内容最多10个字"
            ></el-input>
          </el-form-item>
          <el-form-item label="应用ID" prop="appid" class="attributes">
            <el-input
              clearable
              v-model.trim="alipayParam.configDetail.appid"
              placeholder="请输入内容最多10个字"
            ></el-input>
          </el-form-item>
          <el-form-item
            label="PHP RSA2私钥(原路退回时配置"
            prop="merchantPrivateSecretRSA2"
            class="attributes"
          >
            <el-input
              clearable
              class="scription"
              v-model.trim="alipayParam.configDetail.merchantPrivateSecretRSA2"
              type="textarea"
              placeholder="请输入内容最多10个字"
            ></el-input>
          </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        aliPayPid: [
          { required: true, message: '请输入partnerId', trigger: 'blur' }
        ],
        aliPayAppId: [
          { required: true, message: '请输入sellerEmail', trigger: 'blur' }
        ],
        aliPayPublicSecret: [
        ...
        merchantPrivateSecret: [
          { required: true, message: '请输入PHP私钥', trigger: 'blur' }
        ],
        merchantJavaPrivateSecret: [
          { required: true, message: '请输入java私钥', trigger: 'blur' }
        ],
        appid: [{ required: true, message: '请输入应用ID', trigger: 'blur' }],
        merchantPrivateSecretRSA2: [
          { required: true, message: '请输入PHP RSA2私钥', trigger: 'blur' }
        ]
      }
    }
  },
