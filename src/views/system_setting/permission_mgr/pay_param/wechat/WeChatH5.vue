    ...
    <el-card class="box-card">
      ...
      >
        <el-form-item label="appid" prop="appId" style="width:500px">
          <el-input
            clearable
            v-model.trim="weixinpayParam.configDetail.h5.appId"
        ...
        <el-form-item label="secret" prop="appSecret" style="width:500px">
          <el-input
            clearable
            v-model.trim="weixinpayParam.configDetail.h5.appSecret"
        ...
        <el-form-item label="key" prop="appKey" style="width:500px">
          <el-input
            clearable
            v-model.trim="weixinpayParam.configDetail.h5.appKey"
            placeholder="请输入key"
          ></el-input>
        </el-form-item>
        <el-form-item label="商户号" prop="appAccount">
          <el-input
            clearable
            v-model.trim="weixinpayParam.configDetail.h5.appAccount"
            placeholder="请输入商户号"
          ></el-input>
        </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        apiclientKey: [
          { required: true, message: '请输入SSL秘钥', trigger: 'blur' }
        ]
      },
      rulesTicket: {},
      rulesCoupon: {},
