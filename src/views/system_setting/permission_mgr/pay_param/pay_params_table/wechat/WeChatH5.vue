  ...
  <div>
    <el-card class="box-card">
      <el-form
        ...
        ref="form"
        :rules="rules"
        :model="weixinpayParam.configDetail.h5"
        label-width="150px"
      >
        ...
        <el-form-item label=" " prop="apiclientCert">
          ...
          <el-input
            ...
            :rows="7"
            type="textarea"
            v-model.trim="weixinpayParam.configDetail.h5.apiclientCert"
        ...
        <el-form-item label=" " prop="apiclientKey">
          ...
          <el-input
            ...
            :rows="7"
            type="textarea"
            v-model.trim="weixinpayParam.configDetail.h5.apiclientKey"
    ...
    <el-card class="box-card">
      ...
      >
        ...
        <el-form
          ...
          :ref="'form'+key"
          :rules="rulesTicket"
          :model="weixinpayParam.configDetail.h5.weixinMsgconfig[key]"
          label-width="150px"
        >
          <el-form-item :label="value.title">
            <el-radio
              v-model="weixinpayParam.configDetail.h5.weixinMsgconfig[key].status"
              label="1"
            >开启</el-radio>
            <el-radio
              v-model="weixinpayParam.configDetail.h5.weixinMsgconfig[key].status"
          ...
          <template v-if="weixinpayParam.configDetail.h5.weixinMsgconfig[key].status === '1'">
            <el-form-item label="消息模板ID">
              <remote-select
                ref="msgTemplateId"
                v-model="weixinpayParam.configDetail.h5.weixinMsgconfig[key].templateId"
            ...
            <el-form-item label="消息标题">
              <el-input
                v-model.trim="weixinpayParam.configDetail.h5.weixinMsgconfig[key].title"
                placeholder="请输入消息标题"
              ></el-input>
            </el-form-item>
            <el-form-item label="消息结束语">
              <el-input
                v-model.trim="weixinpayParam.configDetail.h5.weixinMsgconfig[key].endRemarks"
            ...
            <el-form-item>
              <div>
                ...
                <el-row
                  v-if="weixinpayParam.configDetail.h5.weixinMsgconfig[key].templateId"
                  :gutter="20"
                ...
                >
                  ...
                  <el-col :span="6">
                    <el-select
                      clearable
                      v-model="weixinpayParam.configDetail.h5.weixinMsgconfig[key].fieldMap[field.name]"
                      placeholder="请选择"
                    >
                      <el-option
...
export default {
  ...
  methods: {
    ...
    async initTemplateField(type) {
      if (
        this.weixinpayParam.configDetail.h5.weixinMsgconfig[type].templateId
      ) {
