<template>
  <div class="app-container">
    ...
    <div style="margin-left:5%;padding-left:20px;">
      ...
      <el-select clearable v-model="activeIndex">
    ...
    <el-main>
      ...
      <abcpay v-if="activeIndex === 'abcPay'"></abcpay>
    </el-main>
    <!-- </el-container> -->
  </div>
</template>
...
import Abcpay from './Abcpay'
import { getPayConfig } from '@/api/systemSetting'
export default {
  name: 'pay_param_table',
  components: { Alipay, WeChat, Unionpay, Cardpay, Abcpay },
  data() {
    return {
      menus: [
        {
