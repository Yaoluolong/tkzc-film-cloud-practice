<template>
  <el-card>
    <div
      v-for="(trading,index) in value"
      :key="index"
      style="border-bottom:1px #dcdfe6 dashed;margin-bottom:20px;"
    >
      ...
      <el-form ref="form" :params="trading">
        <el-form-item label="预警处理条件：" style="margin-bottom:20px;">
          售票总金额达到合作方预付款&emsp;
          <el-input clearable v-model="trading.warnPercent" style="width:80px;"></el-input>&emsp;%
        </el-form-item>
        ...
        <el-form-item label style="margin-left:110px;margin-bottom:20px;">
          <div>
            并在&emsp;
            <el-input clearable v-model="trading.days" style="width:80px;"></el-input>&emsp;工作日内完成对账。
          </div>
        </el-form-item>
      </el-form>
    </div>
