<template>
  <div>
    ...
    <el-dialog title="选择商家" :visible.sync="dialogVisible" width="600px" @close="resetFields('form')">
        ...
        <el-form inline :model="query"  ref="form" v-show="selectType === '2'">
          <el-form-item prop="name">
              <el-input  v-model="query.name" placeholder="请输入商家名称"></el-input>
          </el-form-item>
          <el-form-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      doChangeFun(val) {
        this.selectedChannelList = this.selectedChannelList.filter(e => e.value !== '-1')
      },
      // init(value) {
