<template>
  <div class="gl-input-box">
    <el-select placeholder="请选择" v-model="value1" class="gl-input"  style="width:100px" @change="change">
      <el-option :label="item.name" :value="item.value" v-for="item in lSelect" :key="item.value"></el-option>
    </el-select>
    <el-input v-model="value2" class="gl-input" @change="change" style="width:100px"></el-input>
    <span >{{unit}},且</span>
    <el-select placeholder="请选择" v-model="value3" class="gl-input"  style="width:100px" @change="change">
      <el-option :label="item.name" :value="item.value" v-for="item in rSelect" :key="item.value"></el-option>
    </el-select>
    <el-input v-model="value4" class="gl-input" @change="change" style="width:100px"></el-input>
    <span>{{unit}}</span>
  </div>
</template>
