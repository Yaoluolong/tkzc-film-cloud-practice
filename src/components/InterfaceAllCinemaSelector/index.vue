      ...
      <el-form inline :model="query" ref="form" v-show="selectType === '2'" class="cinemaCont">
        ...
        <div style="display:inline-block;">
          ...
          <el-form-item style="margin-left:60px">
            <el-button
              type="primary"
              @click="clearCinemaListAndFetchData(query.interfaceTypeId,query.cinemaName)"
            >搜索</el-button>
          </el-form-item>
        </div>
      </el-form>
      ...
      <div class="checkbox-plane" v-show="selectType === '2'">
        ...
        <div class="content" id="content" @scroll="onScroll">
          <div
            ...
            :key="cinema.value+new Date().getTime()+Math.random()"
          >
            <el-checkbox
    ...
    value(val) {
      if (val && val.length > 0) {
        if (this.selectedCinemaList !== val) {
          ...
          this.query.cinemaId = this.selectedCinemaList
            .map(e => e.value)
            .join(',')
        }
      }
    ...
    selectTypeChange(val) {
      if (val === '1') {
        this.selectedCinemaList = [
          { name: '', value: '-1', cinemaCode: '', checked: true }
        ]
      } else {
        this.clearCinemaListAndFetchData(this.query.interfaceTypeId, '')
      }
    ...
    onScroll(event) {
      ...
      if (element.scrollTop + element.clientHeight === element.scrollHeight) {
        if (this.query.page < this.totalPage) {
          ...
          this.query.page === this.totalPage &&
          this.query.getType === '2'
        ) {
