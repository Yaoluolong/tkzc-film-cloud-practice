<template>
  <div>
    ...
    <div
      id="tag-div"
      class="tag-plane"
      v-show="selectedCinemaList&&selectedCinemaList.length>0&&selectTypeBak !== '1'"
      style="max-height:500px;overflow-y: auto;"
    >
      <el-tag
        type="danger"
        @close="delFun(cinema,index)"
        class="selected-item"
...
export default {
  ...
  methods: {
    ...
    doSelectAll(val) {
      this.selectedCinemaList = this.selectedCinemaList.filter(
        e => e.value !== '-1'
      )
