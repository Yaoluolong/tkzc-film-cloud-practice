...
export default {
  ...
  watch: {
    ...
    //   // if (val !== this.query.interfaceTypeId && this.query.interfaceTypeId) {
  ...
  methods: {
    ...
    // getInterfaceTypeId() {
    //   return this.query.interfaceTypeId
    // },
    handleClose(index) {
    ...
    async fetchData() {
      ...
      // if (this.interfaceTypeId && !this.query.interfaceTypeId) {
